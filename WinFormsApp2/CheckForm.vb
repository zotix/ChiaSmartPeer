...
Public Class CheckForm
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If System.IO.File.Exists(FilePath1) Then
            version = "1.1.1"
            BackgroundWorker2update.RunWorkerAsync()
    ...
    Private Sub BackgroundWorker2finder_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker2finder1.DoWork
        ...
        request = DirectCast(WebRequest.Create("http://chianodes.ddns.net/NodeList1.txt"), HttpWebRequest)
    ...
    Private Sub BackgroundWorker2finder2_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker2finder2.DoWork
        ...
        request = DirectCast(WebRequest.Create("http://chianodes.ddns.net/NodeList2.txt"), HttpWebRequest)
    ...
    Private Sub BackgroundWorker2finder3_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker2finder3.DoWork
        ...
        request = DirectCast(WebRequest.Create("http://chianodes.ddns.net/NodeList3.txt"), HttpWebRequest)
    ...
    Private Sub BackgroundWorker2finder4_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker2finder4.DoWork
        ...
        request = DirectCast(WebRequest.Create("http://chianodes.ddns.net/NodeList4.txt"), HttpWebRequest)
    ...
    Private Sub BackgroundWorker2update_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker2update.DoWork
        Dim request As HttpWebRequest
        Dim response As HttpWebResponse
        Dim reader As StreamReader

        request = DirectCast(WebRequest.Create("http://chianodes.ddns.net/update.txt"), HttpWebRequest)
        response = DirectCast(request.GetResponse(), HttpWebResponse)
        reader = New StreamReader(response.GetResponseStream())
        Dim rawresp As String
        rawresp = reader.ReadToEnd()
        If rawresp = "true" Then
            MessageBox.Show("Chia Smart Peer new version 2.0 is out! https://github.com/ChiaNetworkTools/ChiaSmartPeer/releases", "version 2.0 Is out")
        End If
    End Sub
End Class
